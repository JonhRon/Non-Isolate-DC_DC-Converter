...
clc, clear, close all;
%% Input Parameter of EE19 ferrite Core
MPL = 3.94; % Magnetic Path Length [ cm ]
We = 4.85; % Core Weight [ grams ]
MLT = 3.69; % Mean Length Turn [ cm ]
Ac = 0.23; % Iron Core or Cross-Sectional area [ cm^2 ]
Wa = 0.284; % Window Area or Bobbin winding area[ cm^2 ]
Ap = Ac * Wa; % Core Product [ cm^4 ]
Kg = 4.07e-3; % Core Geometry [ cm^5 ]
...
Aws = 0.01; % Select bare wier area
N = (Waeff * S2) / Aws;
